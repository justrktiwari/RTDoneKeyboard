...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Ajay_upwork/RTDoneKeyboard'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Ajay_upwork' => 'Ajay_upwork@dhani.com' }
  s.source           = { :git => 'https://github.com/Ajay_upwork/RTDoneKeyboard.git', :tag => s.version.to_s }
